...
example_data_url = ('https://github.com/mueslo/fplore_example_data/'
                    'releases/download/v2/example_data.tar.gz')
...
if not os.path.exists(example_data_dir):
    ...
    file_tmp = urllib.request.urlretrieve(example_data_url, filename=None)[0]
    base_name = os.path.basename(example_data_url)
...
latex_documents = [
    (master_doc, 'fplore.tex', 'fplore Documentation',
     'Johannes Falke', 'manual'),
]
...
man_pages = [
    (master_doc, 'fplore', 'fplore Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'fplore', 'fplore Documentation',
     author, 'fplore', 'One line description of project.',
     'Miscellaneous'),
]
